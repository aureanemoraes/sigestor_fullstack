...
@section('content')
<h3>LISTA LOAS - UNIDADES ADMINISTRATIVAS</h3>
<section>
        ...
        <tr>
          ...
          <td>
              <div class="btn-group btn-group-sm" role="group" aria-label="acoes">
                <a type="button" href="{{ route('loa_administrativa.index', ['ploa' => $exercicio->id]) }}" class="btn btn-primary" ><i class="bi bi-search"></i></a>
              </div>
          </td>
        </tr>
        @endforeach
