...
<form action="{{ $route }}" method="POST" id="form">
    ...
    <div class="mb-3 col-4">
      ...
      <select class="form-select @error('exercicio_id') is-invalid @enderror" id="exercicio_id" name="exercicio_id" aria-label="Selecione o grupo">
        ...
        @foreach($exercicios as $exercicios)
          @if(isset($ploa_gestora) && $exercicios->id == $ploa_gestora->exercicio_id)
  ...
  <div class="form-floating mb-3">
    <input type="number" class="form-control @error('valor') is-invalid @enderror" id="valor" name="valor" value="{{ isset($ploa_gestora->valor) ? $ploa_gestora->valor : null}}" placeholder="Nome...">
