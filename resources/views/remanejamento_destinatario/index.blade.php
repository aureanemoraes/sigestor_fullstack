                                      ...
                                      <tbody>
                                          @foreach($natureza_despesa->despesas as $despesa)
                                              ...
                                              <tr>
                                                ...
                                                <td>{{ $despesa->tipo }}</td>
                                                <td>
                                                  @if($despesa->possui_remanejo_em_andamento)
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="acoes">
                                                      <a type="button" href="{{ route('remanejamento.create', ['despesa' => $despesa->id]) }}" class="btn btn-primary" >Remanejar valor <i class="bi bi-box-arrow-right"></i></a>
                                                    </div>
                                                  @else
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="acoes">
                                                      <a type="button" href="{{ route('remanejamento.create', ['despesa' => $despesa->id]) }}" class="btn btn-primary" >Liberar valor <i class="bi bi-box-arrow-right"></i></a>
                                                    </div>
                                                  @endif
                                                </td>
                                              </tr>
