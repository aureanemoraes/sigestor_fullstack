...
<section class="d-flex justify-content-end mb-2">
  <a href="{{ route('programa.create') }}" type="button" class="btn btn-primary">
    Novo
  </a>
</section>
<section>
          ...
          <td class="action-buttons">
            ...
            <form action="{{ route('programa.destroy', $programa->id) }}" method="post" id="form-delete">
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="acoes">
                <a type="button" href="{{ route('programa.edit', $programa->id) }}" class="btn btn-primary" ><i class="bi bi-pen-fill"></i></a>
