...
@section('js')
  <script>
    ...
    function loadConfsDespesa() {
      let despesa_modelo = JSON.parse($('#despesa_modelo').val());
      if(despesa_modelo.fields) {
        for(key in despesa_modelo.fields) {
          let field = despesa_modelo.fields[key];
          let html = `
          ...
          // despesa_modelo.fields.map( field => {
          //   console.log(field);
          // let html = `
          // <div class="input-group input-group-sm mb-3 col-4 fields" id="${field}">
