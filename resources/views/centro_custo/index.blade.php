...
<section class="d-flex justify-content-end mb-2">
  <a href="{{ route('centro_custo.create') }}" type="button" class="btn btn-primary">
    Novo
  </a>
</section>
<section>
          ...
          <td class="action-buttons">
            <form action="{{ route('centro_custo.destroy', $centro_custo->id) }}" method="post" id="form-delete">
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="acoes">
                <a type="button" href="{{ route('centro_custo.edit', $centro_custo->id) }}" class="btn btn-primary" ><i class="bi bi-pen-fill"></i></a>
